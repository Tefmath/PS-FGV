...
O arquivo de dados limpos gerado na Etapa 1 está na pasta dados com o nome ```noticias_limpas.json```.
...
Observando os valores dos escores feitos a Etapa 3 do ```notebook.ipynb```, cheguei na conclusão de que ambos modelos performaram muito bem no quesito achar documentos similares à pesquisa feita, porém, o que se destaca mais no geral parece ser o modelo **paraphrase-multilingual-mpnet-base-v2**. 
